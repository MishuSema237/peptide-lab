...
export default function AdminSidebar() {
    ...
    const menuItems = [
        { name: 'Overview', href: '/admin', icon: 'M4 6h16M4 12h16M4 18h16' },
        { name: 'Categories', href: '/admin/categories', icon: 'M7 7h10v10H7z' }, // Added Categories
    ...
    return (
        <>
            ...
            <aside className={`w-64 bg-dark text-white h-screen fixed left-0 top-0 overflow-y-auto z-50 transition-transform duration-300 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="p-6 flex items-center justify-between">
                    <h1 className="text-2xl font-heading font-bold text-accent">AdminPanel</h1>
